 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://webservicedemo.distributed.drafire.com/", wsdlLocation = "http://localhost:8888/sayhello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://webservicedemo.distributed.drafire.com/", "SayHelloImplService");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://webservicedemo.distributed.drafire.com/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservicedemo.distributed.drafire.com/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
